...
namespace Tjl.BookStore
{
    ...
    public static class WebContentDirectoryFinder
    {
        public static string CalculateContentRootFolder()
        {
            ...
            while (!DirectoryContains(directoryInfo.FullName, "Tjl.BookStore.sln"))
            {
            ...
            var webFolder = Path.Combine(directoryInfo.FullName, $"src{Path.DirectorySeparatorChar}Tjl.BookStore.Web");
